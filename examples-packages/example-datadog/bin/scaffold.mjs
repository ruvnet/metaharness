#!/usr/bin/env node
// @metaharness/example-datadog — one-command scaffold.
// Delegates host wiring to the metaharness CLI, then prints datadog-specific
// next steps. Read-only / sandbox by default; mutations need --allow-mutations.
import { execSync } from 'node:child_process';
import process from 'node:process';

const PKG = '@metaharness/example-datadog';
const SDK = "@datadog/datadog-api-client";
const ENV_VARS = ["DD_API_KEY", "DD_APP_KEY", "DD_SITE"];
const COMMAND = "/dd-triage";
