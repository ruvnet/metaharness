#!/usr/bin/env node
// @metaharness/example-iot — one-command scaffold.
// Delegates host wiring to the metaharness CLI, then prints iot-specific
// next steps. Read-only / sandbox by default; mutations need --allow-mutations.
import { execSync } from 'node:child_process';
import process from 'node:process';

const PKG = '@metaharness/example-iot';
const SDK = "mqtt";
const ENV_VARS = ["MQTT_URL", "MQTT_USERNAME", "MQTT_PASSWORD"];
const COMMAND = "/iot-telemetry";
