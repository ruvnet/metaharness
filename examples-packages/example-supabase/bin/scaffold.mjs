#!/usr/bin/env node
// @metaharness/example-supabase — one-command scaffold.
// Delegates host wiring to the metaharness CLI, then prints supabase-specific
// next steps. Read-only / sandbox by default; mutations need --allow-mutations.
import { execSync } from 'node:child_process';
import process from 'node:process';

const PKG = '@metaharness/example-supabase';
const SDK = "@supabase/supabase-js";
const ENV_VARS = ["SUPABASE_URL", "SUPABASE_ANON_KEY"];
const COMMAND = "/supabase-query";
