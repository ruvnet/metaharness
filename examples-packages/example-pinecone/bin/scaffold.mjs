#!/usr/bin/env node
// @metaharness/example-pinecone — one-command scaffold.
// Delegates host wiring to the metaharness CLI, then prints pinecone-specific
// next steps. Read-only / sandbox by default; mutations need --allow-mutations.
import { execSync } from 'node:child_process';
import process from 'node:process';

const PKG = '@metaharness/example-pinecone';
const SDK = "@pinecone-database/pinecone";
const ENV_VARS = ["PINECONE_API_KEY"];
const COMMAND = "/pinecone-rag";
