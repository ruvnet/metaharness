#!/usr/bin/env node
// @metaharness/example-twilio — one-command scaffold.
// Delegates host wiring to the metaharness CLI, then prints twilio-specific
// next steps. Read-only / sandbox by default; mutations need --allow-mutations.
import { execSync } from 'node:child_process';
import process from 'node:process';

const PKG = '@metaharness/example-twilio';
const SDK = "twilio";
const ENV_VARS = ["TWILIO_ACCOUNT_SID", "TWILIO_AUTH_TOKEN"];
const COMMAND = "/twilio-send";
