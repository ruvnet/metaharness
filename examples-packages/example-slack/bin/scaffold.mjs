#!/usr/bin/env node
// @metaharness/example-slack — one-command scaffold.
// Delegates host wiring to the metaharness CLI, then prints slack-specific
// next steps. Read-only / sandbox by default; mutations need --allow-mutations.
import { execSync } from 'node:child_process';
import process from 'node:process';

const PKG = '@metaharness/example-slack';
const SDK = "@slack/web-api";
const ENV_VARS = ["SLACK_BOT_TOKEN"];
const COMMAND = "/slack-triage";
