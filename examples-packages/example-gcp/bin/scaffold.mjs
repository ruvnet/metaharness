#!/usr/bin/env node
// @metaharness/example-gcp — one-command scaffold.
// Delegates host wiring to the metaharness CLI, then prints gcp-specific
// next steps. Read-only / sandbox by default; mutations need --allow-mutations.
import { execSync } from 'node:child_process';
import process from 'node:process';

const PKG = '@metaharness/example-gcp';
const SDK = "@google-cloud/storage @google-cloud/bigquery";
const ENV_VARS = ["GOOGLE_APPLICATION_CREDENTIALS", "GCP_PROJECT"];
const COMMAND = "/gcp-ops";
