#!/usr/bin/env node
// @metaharness/example-github — one-command scaffold + bespoke agent bundle.
...
const PKG = '@metaharness/example-github';
const SDK = "@octokit/rest";
const ENV_VARS = ["GITHUB_TOKEN", "GITHUB_OWNER", "GITHUB_REPO"];
const COMMAND = "/review-pr";
