...
import { loadGenome, type Genome } from './genome.js';
 ...
 */
export const CAND6_GENOME_PATH: string = fileURLToPath(
  new URL('../../genomes/genome-promoted-cand6-edit-by-midpoint.json', import.meta.url),
);

/** Load + validate the shipped cand-6 promoted genome. */
export function loadCand6Genome(): Genome {
