// @metaharness/evals-math — COST-AWARE 3-PASS ROUTING.
//
// Pass 1: cheap model, strict answer format, no verifier.
// Pass 2: same/mid model + symbolic-recompute verifier + numeric normalization.
...
export interface EscalationSignals {
  ...
  /** Optional prior: this subtopic is high-error for the cheap model. */
