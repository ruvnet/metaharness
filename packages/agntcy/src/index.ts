...
// integration for generated MetaHarness agents. See docs/adrs/ADR-237-agntcy-identity-oasf-observability.md
...
//
//   - ./src/identity/  — ADR-237 §2.1: W3C DID minting, verifiable-credential badges
...
//
//   - ./src/oasf/       — ADR-237 §2.2: Open Agentic Schema Framework capability-record
...
//
//   - ./src/casa/       — ADR-237 §4: the CASA intent-to-authority-envelope compiler.
