...
// Generated by metaharness — the `kimi-k3-harness` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx kimi-k3-harness`
...
// "bin" + "files" fields in package.json), so `npx kimi-k3-harness` works the moment
...
const HARNESS_NAME = 'kimi-k3-harness';

/** `kimi-k3-harness init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `kimi-k3-harness doctor` — verify the install end-to-end (kernel + host resolve). */
