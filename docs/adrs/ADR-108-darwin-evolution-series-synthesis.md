...
**Indexes**: ADR-084 … ADR-130 (the evolution stack + the SWE-bench arc, built on the ADR-070…083 baseline)
...
9. **The SWE-bench arc (117–130)** — from real multi-file reasoning to a self-scoring harness:
